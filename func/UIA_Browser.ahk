...
class UIA_Browser {
	...
	ClosePreviousTab(matchMode:=3, caseSensitive:=True) {

		MsgBox("--close--prev--works--")
		 ...
		 */
		 ...
		 ;~ try this.TWT.GetLastChildElement(this.GetTab()).Click()
		 ;~ try this.TWT.GetLastChildElement(this.GetTab()).GetNextSiblingElement(this.GetTab()).Click()
		 try this.TWT.GetNextSiblingElement(this.GetTab()).Click()
		 try this.TWT.GetLastChildElement(this.GetTab()).Click()
